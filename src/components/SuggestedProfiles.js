...
export default function SuggestedProfiles({ limit = 4 }) {
  ...
  return <section className={styles.Panel} aria-labelledby="suggested-people-title"><h2 className={styles.PanelTitle} id="suggested-people-title">Suggested people</h2>
