        ...
        <Col md={7} lg={6} className="p-0 p-md-2">
          <Container className={appStyles.Content}>
            ...
            <div>
              <Button
                className={`${btnStyles.Button} ${btnStyles.Blue}`}
                onClick={() => navigateToLink("/dogprofiles/doghealth/create")}
              >
                <i className="fas fa-plus"></i>
                <i className="fas fa-dog"></i>
            ...
            <div>
              <Button
                className={`${btnStyles.Button} ${btnStyles.Blue}`}
                onClick={() => navigateToLink("/dogprofiles/dogdanger/create")}
              >
                <i className="fas fa-plus"></i>
                <i className="fas fa-dog"></i>
...
//       if (currentUser?.profile_id?.toString() === id) {
//         if (currentUser?.dog_profile_id) {
//           history.push(`/dogprofiles/edit/${currentUser.dog_profile_id}`);
//           return;
//         }
