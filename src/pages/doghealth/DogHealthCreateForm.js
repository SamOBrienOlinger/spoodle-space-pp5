...
function DogHealthCreateForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      NotificationManager.success('Doggy health created!', 'Success');
  ...
  return (
    <FormPage title="Doggy health" description="Keep vet contacts and your dog’s health notes together." icon="health" onSubmit={handleSubmit} errors={errors} submitLabel="Create Doggy health" busyLabel="Saving…" onCancel={() => history.goBack()}>
